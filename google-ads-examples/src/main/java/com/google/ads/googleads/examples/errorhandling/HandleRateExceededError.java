...
import com.google.ads.googleads.v2.errors.QuotaErrorEnum.QuotaError;
        ...
        try {
          while (retryCount < NUM_RETRIES) {
            try {
              ...
              // Makes the mutate request. The result set will be empty since
              // validateOnly is set to true in the MutateAdGroupCriteria request.
