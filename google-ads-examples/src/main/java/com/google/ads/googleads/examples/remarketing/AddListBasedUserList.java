...
/** Creates a combination user list containing users that are present on any one of the provided user lists. */
public class AddListBasedUserList {
  ...
  public static void main(String[] args) {
    ...
    try {
      new AddListBasedUserList()
          .runExample(googleAdsClient, params.customerId, params.userListIds);
